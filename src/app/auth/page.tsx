      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8">
          <div>
            ...
            <h1 className="text-5xl font-display font-bold text-birthday-purple mb-6">
              Never Miss Another
              <span className="text-birthday-orange block">Special Moment</span>
            </h1>
          ...
          <div className="space-y-6">
            {benefits.map((benefit, index) => (
              <div key={index} className="flex items-center space-x-4">
                <div className="p-3 rounded-full bg-birthday-gradient text-white">
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-3xl font-bold text-birthday-purple">50K+</div>
              <div className="text-sm text-muted-foreground">Cards Sent</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-birthday-orange">25K+</div>
              <div className="text-sm text-muted-foreground">Gifts Delivered</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-birthday-pink">99%</div>
          ...
          <Card className="shadow-2xl">
            ...
            <CardContent className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button
                  type="submit"
                  className="w-full bg-birthday-gradient hover:opacity-90 text-white text-lg"
                >
              ...
              <div className="text-center">
                <p className="text-sm text-muted-foreground">
                  ...
                  <button
                    ...
                    className="ml-1 font-medium text-birthday-purple hover:text-birthday-orange transition-colors"
                  >
