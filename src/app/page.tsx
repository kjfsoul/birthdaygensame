            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-white space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button size="lg" className="bg-white text-birthday-purple hover:bg-birthday-yellow hover:text-white text-lg px-8 animate-pulse-glow">
                    <Zap className="h-5 w-5 mr-2" />
                    Start Creating
                  </Button>
                  <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-birthday-purple">
                    Explore Tools
