...
interface Holiday {
  ...
  name: string
  date: string
  category: 'birthday' | 'holiday' | 'personal' | 'religious'
  isRecurring: boolean
  cardTemplate?: string
...
export default function AutomationPage() {
  const [activeTab, setActiveTab] = useState<'contacts' | 'holidays' | 'automation' | 'settings'>('contacts')
  ...
  const [holidays] = useState<Holiday[]>([
    { id: '1', name: 'New Year', date: '2025-01-01', category: 'holiday', isRecurring: true },
    { id: '2', name: 'Valentine\'s Day', date: '2025-02-14', category: 'holiday', isRecurring: true },
    { id: '3', name: 'Mother\'s Day', date: '2025-05-11', category: 'holiday', isRecurring: true },
    { id: '4', name: 'Father\'s Day', date: '2025-06-15', category: 'holiday', isRecurring: true },
    { id: '5', name: 'Halloween', date: '2025-10-31', category: 'holiday', isRecurring: true },
    { id: '6', name: 'Thanksgiving', date: '2025-11-27', category: 'holiday', isRecurring: true },
    { id: '7', name: 'Christmas', date: '2025-12-25', category: 'holiday', isRecurring: true },
    { id: '8', name: 'Easter', date: '2025-04-20', category: 'religious', isRecurring: true },
    { id: '9', name: 'Graduation Day', date: '2025-05-20', category: 'personal', isRecurring: false }
  ])
    ...
    if (newContact.name && newContact.email) {
      const contact: Contact = {
        ...
        preferences: {
          ...
          giftBudget: newContact.giftBudget
        },
        relationships: ['friend'],
        automationEnabled: true
      }
      setContacts(prev => [...prev, contact])
      setNewContact({ name: '', email: '', birthday: '', interests: [], giftBudget: '$25-50' })
    }
  }
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      case 'birthday': return 'bg-birthday-pink text-white'
      case 'holiday': return 'bg-birthday-orange text-white'
      case 'personal': return 'bg-birthday-purple text-white'
      case 'religious': return 'bg-birthday-blue text-white'
          ...
          <div className="bg-white rounded-lg p-2 shadow-lg">
            <div className="flex space-x-2">
              {tabs.map((tab) => (
                <button
                  key={tab.id}
                  onClick={() => setActiveTab(tab.id as 'contacts' | 'holidays' | 'automation' | 'settings')}
              ...
              <CardContent className="space-y-6">
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center p-6 border-2 border-dashed border-gray-300 rounded-lg">
                    ...
                    <h4 className="font-semibold mb-2">Automatic1111 API</h4>
                    <p className="text-sm text-muted-foreground mb-4">Local SDXL generation</p>
                    <Button size="sm" variant="outline">Configure</Button>
                  </div>

                  <div className="text-center p-6 border-2 border-dashed border-gray-300 rounded-lg">
                    <Upload className="h-12 w-12 text-gray-400 mx-auto mb-4" />
                    <h4 className="font-semibold mb-2">Image Vault</h4>
                    <p className="text-sm text-muted-foreground mb-4">Pre-curated images</p>
                    <Button size="sm" variant="outline">Manage</Button>
                  </div>

                  <div className="text-center p-6 border-2 border-dashed border-gray-300 rounded-lg">
                    <Palette className="h-12 w-12 text-gray-400 mx-auto mb-4" />
                    <h4 className="font-semibold mb-2">Custom Uploads</h4>
                    <p className="text-sm text-muted-foreground mb-4">Your own images</p>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {[
                      'Email notifications for sent cards',
