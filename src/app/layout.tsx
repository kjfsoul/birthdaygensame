            ...
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-300">
                  ...
                  <li><a href="/countdown" className="hover:text-birthday-pink transition-colors">Countdown Timer</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-300">
                  <li><a href="/memories" className="hover:text-birthday-pink transition-colors">Share Memories</a></li>
